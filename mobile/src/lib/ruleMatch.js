...
// (eligible > indeterminate > not_eligible). Used only for the Explore tab's "quick match"
// against arbitrary filter values (not the citizen's saved profile), so filter changes get
// instant feedback without a backend round trip. Mirrors frontend/src/lib/ruleMatch.js.
